// bc-confined-space MCP tool registrations — WorkSafeBC (British Columbia) OHS Regulation
// reference tools, shared by the stdio server (server.js) and the Cloudflare Worker (worker.js).
//
// Design rules:
